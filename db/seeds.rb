...
subscription4 = FlowerSubscription.create(size: 'medium', frequency: 1, price_cents: 40, user_id: user4.id, delivery_day: "Tuesday", delivery_date: '2020-09-03 12:32:52', state: 'received')
