...
subscription1 = FlowerSubscription.create(size: 'small', frequency: 1, price_cents: 2500, user_id: user1.id, delivery_day: "Monday", time_of_day: '13pm-15pm', delivery_date: '2020-09-03 12:32:52', state: 'pending', supplier_id: supplier1.id)
...
subscription3 = FlowerSubscription.create(size: 'small', frequency: 4, price_cents: 2500, user_id: user3.id, delivery_day: "Monday", time_of_day: '13pm-15pm', delivery_date: '2020-09-03 12:32:52', state: 'received', supplier_id: supplier1.id)
...
subscription6 = FlowerSubscription.create(size: 'medium', frequency: 4, price_cents: 4000, user_id: user1.id, delivery_day: "Tuesday", time_of_day: '13pm-15pm', delivery_date: '2020-09-03 12:32:52', state: 'received', supplier_id: supplier2.id)
...
subscription8 = FlowerSubscription.create(size: 'large', frequency: 1, price_cents: 5500, user_id: user3.id, delivery_day: "Wednesday", time_of_day: '13pm-15pm', delivery_date: '2020-09-03 12:32:52', state: 'received', supplier_id: supplier1.id)
...
subscription10 = FlowerSubscription.create(size: 'large', frequency: 4, price_cents: 5500, user_id: user5.id, delivery_day: "Thursday", time_of_day: '13pm-15pm', delivery_date: '2020-09-03 12:32:52', state: 'received', supplier_id: supplier1.id)
